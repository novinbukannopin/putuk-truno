                ...
                <div className={"flexCenter gap-6"}>
                    <span className={"flex -space-x-4 overflow-hidden"}>
                        {PEOPLE_URL.map((url, index) => (
                            <Image key={index} src={url} alt={"people"} width={52} height={52}
    ...
    return (
        <section
            ...
            <div
                ...
                <CampSite backgroundImage={"bg-bg-img-1"} title={"Camp 1"} subtitle={"Subtitle 1"}
                          peopleJoined={"50+ joined"}/>
                <CampSite backgroundImage={"bg-bg-img-1"} title={"Camp 1"}
                          subtitle={"Subtitle 1"}
                          peopleJoined={"50+ joined"}/>
            </div>
            ...
            <div className={"flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6"}>
                <div
                    ...
                    <p className={"regular-14 xl:regular-16 mt-5 text-white"}>
                        ...
                        of getting lost is very large. thats why we are here for those of you who want to start an
                        adventure
                    </p>
                    <Image src={"/quote.svg"} alt={"camp-2"} width={189} height={219} className={"camp-quote"}/>
                </div>
            </div>
        </section>
    );
