...
const Hero = () => {
    return (
        <section
            className={"max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-8 lg:py-20 xl:flex-row"}>
            <div className={"hero-map"}/>
            <div className={"relative z-20 flex flex-1 flex-col xl:w-1/2"}>
                <Image src={"/camp.svg"} alt={"camp"} width={50} height={50}
                       className={"absolute left-[-5px] top-[-30px] w-10 lg:w-[50px]"}/>
                <h1 className={"bold-52 lg:bold-88"}>Uinsa</h1>
                ...
                <div className={"my-11 flex flex-wrap gap-5"}>
                    <div className={"flex items-center gap-2"}>
                        {Array(5).fill(0).map((_, i) => (
                            <Image src={"/star.svg"} alt={"star"} key={i} width={24} height={24}/>
                        ))}
                    </div>
            ...
            <div className="relative flex flex-1 items-start">
                <div className="relative z-20 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="bold-20 text-white">Ultramen</p>
                    </div>
